...
INSERT INTO "new_Invoice" ("clientAddress", "clientEmail", "clientId", "clientName", "createdAt", "dueDate", "id", "invoiceNumber", "issueDate", "notes", "paymentTerms", "status", "subtotal", "taxAmount", "taxRate", "total", "updatedAt", "vendorId") SELECT "clientAddress", "clientEmail", "clientId", "clientName", "createdAt", "dueDate", "id", "invoiceNumber", "issueDate", "notes", "paymentTerms", "status", "subtotal", "taxAmount", "taxRate", "total", "updatedAt", "vendorId" FROM "Invoice";
DROP TABLE "Invoice";
